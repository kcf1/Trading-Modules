...
for params in params_DonchianBand:
    model = FilteredDonchianBand(1, params=params, bars=bars)
    weighted_bet_df[f'{params["channel_lookback"]}'] = model.walkforward(
