...
from modules.trading_models_test.rule_based_models import BollingerBand
...
for params in params_BollingerBand:
    model = BollingerBand(1, params=params, bars=bars)
